...
function M.get(colors)
    return {
        ...
        DiffAdd = { fg = colors.green, bg = colors.green4 },
        DiffChange = { fg = colors.yellow, bg = colors.yellow4 },
        DiffDelete = { fg = colors.red, bg = colors.red4 },
        DiffText = { fg = colors.tx, bg = colors.yellow3 },
        EndOfBuffer = { link = "NonText" },
        TermCursor = { link = "Cursor" },
        ErrorMsg = { fg = colors.red },
        WinSeparator = { fg = colors.ui },
        ...
        CursorLineNr = { fg = colors.tx2, bg = colors.bg2, bold = true },
        CursorLineFold = { link = "CursorLineSign" },
        CursorLineSign = { fg = colors.tx3, bg = colors.bg2 },
        MatchParen = { fg = colors.tx2, bold = true },
        ...
        PmenuMatch = { fg = colors.tx2, bold = true },
        ...
        DiagnosticUnderlineHint = { sp = colors.tx2, undercurl = true },
        ...
        ["@variable"] = { fg = colors.tx },
        ["@variable.builtin"] = { fg = colors.magenta },
        ["@variable.parameter"] = { fg = colors.tx2 },
        ...
        ["@markup.list.checked"] = { fg = colors.green, bg = colors.green4 },
        ["@markup.list.unchecked"] = { fg = colors.tx2, bg = colors.bg2 },
        ...
        ["@tag.attribute"] = { fg = colors.tx2 },
        ["@tag.delimiter"] = { fg = colors.tx2 },
